...
LOCAL_POST_INSTALL_CMD := rm -rf $(TARGET_ROOT_OUT)/vendor $(TARGET_RECOVERY_ROOT_OUT)/vendor; ln -s /system/vendor $(TARGET_ROOT_OUT)/vendor; rm -f $(LOCAL_INSTALLED_MODULE)
