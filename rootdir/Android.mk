...
LOCAL_POST_INSTALL_CMD := rm -rf $(TARGET_ROOT_OUT)/vendor $(TARGET_RECOVERY_ROOT_OUT)/vendor $(TARGET_OUT)/system; ln -s /system/vendor $(TARGET_ROOT_OUT)/vendor; ln -s / $(TARGET_OUT)/system; mkdir -p $(TARGET_OUT)/bugreports/bugreports
