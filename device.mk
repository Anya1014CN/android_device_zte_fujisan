...
# Bring-up: drop msm/qcom audio path (mixer open can hang AudioPolicy and
# block SystemServer). Ship AOSP default primary so media.audio_policy
# registers immediately; restore real HALs later.
PRODUCT_PACKAGES += \
